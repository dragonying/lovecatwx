...
$robot = Robot::init('localhost', 8090);
...
class Robot
{
     ...
     * >>> SendMusicMsg 发送音乐分享 robot_wxid, to_wxid(群/好友), msg(name, type)
     ...
     * >>> AcceptTransfer 接收好友转账 robot_wxid, to_wxid,  msg(接收到事件里的msg原样传回)
        ...
        foreach ($key as $v) {
            if ($this->startWith($msg, $v)) {
                ...
                return [
                    ...
                    "member_name" => '',
                    "group_wxid" => '',
                    "msg" => "您好,要论坛邀请码吗？[@emoji=\uD83C\uDF40]\n[@emoji=\uD83D\uDCDD]捐赠>=5元即可获得哦\n[@emoji=\uD83C\uDF40]点击 https://iderge.com/2.sl 识别二维码捐赠\n[打脸]捐赠完成后会自动回复给您邀请码～",
                ];
            }
        }
        return false;
